...
router.get(
  ...
  usersMenuController.contactform
);
router.put(
  "/contact",
  userNotLoggedMiddleware,
  UserContactValidator,
  usersMenuController.contactAction
);
//datos basicos
...
router.put(
  "/name",
  userNotLoggedMiddleware,
  basicDataUserValidator,
  usersMenuController.nameAction
);
//actualizar password
...
router.put(
  "/password",
  userNotLoggedMiddleware,
  usersMenuPasswordValidator,
  usersMenuController.passwordUpdate
);
//Subir foto
...
router.put(
  ...
  usersMenuController.avatarAction
);
//actualizar mail
